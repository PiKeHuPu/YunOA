...
class SpecialRole(models.Model):
    ...
    特殊角色： 比如打款人：
    """
    special_role = sc['special_role']

    title = models.CharField(max_length=10, choices=special_role, verbose_name='角色名')
    user = models.ForeignKey(User, related_name='special_role', verbose_name='当前审批人')