...
CHOICES = {
    ...
    'WorkOrderLog_type': (('0', '审批'), ('1', '报销')),  # 审批日志类型
    'WorlOrder_status': (('0', '等待审批'), ('1', '审批中'), ('2', '审批完成'), ('3', '审批被退回'), ('4', '预付款完成'), ('5','等待预付款'), ('6', '报销完成')),  # 审批状态 0：可以修改，1：不能修改
    'Apply_status': (('-1', '可以申请'), ('0', '等待审批'), ('1', '审批中'), ('2', '审批完成'), ('3', '审批被退回'), ('4', '付款完成'), ('5','等待付款')),  # 审批状态 0：可以修改，1：不能修改
